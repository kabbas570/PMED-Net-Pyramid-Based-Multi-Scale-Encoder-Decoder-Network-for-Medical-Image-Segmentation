...
mask_id = []
for infile in sorted(glob.glob('/home/user01/data_ssd/Abbas/Medical_Images/X_Ray_1/train/masks/*.png')):
    mask_id.append(infile)
image_ = []
for infile in sorted(glob.glob('/home/user01/data_ssd/Abbas/Medical_Images/X_Ray_1/train/images/*.png')):
    image_.append(infile)

mask_V = []
for infile in sorted(glob.glob('/home/user01/data_ssd/Abbas/Medical_Images/X_Ray_1/valid/masks/*.png')):
    mask_V.append(infile)
image_V = []
for infile in sorted(glob.glob('/home/user01/data_ssd/Abbas/Medical_Images/X_Ray_1/valid/images/*.png')):
    image_V.append(infile)
mask_T = []
for infile in sorted(glob.glob('/home/user01/data_ssd/Abbas/Medical_Images/X_Ray_1/test/masks/*.png')):
    mask_T.append(infile)
image_T = []
for infile in sorted(glob.glob('/home/user01/data_ssd/Abbas/Medical_Images/X_Ray_1/test/images/*.png')):
