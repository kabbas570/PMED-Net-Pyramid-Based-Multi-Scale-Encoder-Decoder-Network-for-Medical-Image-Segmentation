...
mask_id = []
for infile in sorted(glob.glob('/home/user01/data_ssd/Abbas/NUCLEI/train/masks/*.png')):
    mask_id.append(infile)
image_ = []
for infile in sorted(glob.glob('/home/user01/data_ssd/Abbas/NUCLEI/train/images/*.png')):
    image_.append(infile)
mask_V = []
for infile in sorted(glob.glob('/home/user01/data_ssd/Abbas/NUCLEI/valid/masks/*.png')):
    mask_V.append(infile)
image_V = []
for infile in sorted(glob.glob('/home/user01/data_ssd/Abbas/NUCLEI/valid/images/*.png')):
    image_V.append(infile)
mask_T = []
for infile in sorted(glob.glob('/home/user01/data_ssd/Abbas/NUCLEI/test/masks/*.png')):
    mask_T.append(infile)
image_T = []
for infile in sorted(glob.glob('/home/user01/data_ssd/Abbas/NUCLEI/test/images/*.png')):
