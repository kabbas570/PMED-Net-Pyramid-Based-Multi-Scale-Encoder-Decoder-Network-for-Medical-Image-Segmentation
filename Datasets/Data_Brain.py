...
import glob
mask_id = []
for infile in sorted(glob.glob('/home/user01/data_ssd/Abbas/BRAIN_MRI/train/masks/*.png')):
    mask_id.append(infile)
image_ = []
for infile in sorted(glob.glob('/home/user01/data_ssd/Abbas/BRAIN_MRI/train/images/*.png')):
    image_.append(infile)
mask_V = []
for infile in sorted(glob.glob('/home/user01/data_ssd/Abbas/BRAIN_MRI/valid/masks/*.png')):
    mask_V.append(infile)
image_V = []
for infile in sorted(glob.glob('/home/user01/data_ssd/Abbas/BRAIN_MRI/valid/images/*.png')):
    image_V.append(infile)
mask_T = []
for infile in sorted(glob.glob('/home/user01/data_ssd/Abbas/BRAIN_MRI/test/masks/*.png')):
    mask_T.append(infile)
image_T = []
for infile in sorted(glob.glob('/home/user01/data_ssd/Abbas/BRAIN_MRI/test/Images/*.png')):
